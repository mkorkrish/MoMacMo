...
# Plot the distribution of Channel 11 and Channel 12
fig, axes = plt.subplots(nrows=2, ncols=1, figsize=(8, 6))

axes[0].hist(time_point_0, bins=20, color='b', alpha=0.5)
axes[0].set_xlabel('Channel 11', fontsize=10)
axes[0].set_ylabel('Frequency', fontsize=10)
axes[0].set_title('Distribution: Channel 11', fontsize=12)

axes[1].hist(time_point_1, bins=20, color='r', alpha=0.5)
axes[1].set_xlabel('Channel 12', fontsize=10)
axes[1].set_ylabel('Frequency', fontsize=10)
axes[1].set_title('Distribution: Channel 12', fontsize=12)
...
######################
# 8. Fix for Memory Leak Warning in K-means
######################
...
kmeans_labels = kmeans.fit_predict(channels)

# Perform Agglomerative clustering
agglomerative = AgglomerativeClustering(n_clusters=3)
agglomerative_labels = agglomerative.fit_predict(channels)

# Perform DBSCAN clustering
dbscan = DBSCAN(eps=0.5, min_samples=5)
dbscan_labels = dbscan.fit_predict(channels)

# Perform Spectral clustering
spectral = SpectralClustering(n_clusters=3)
spectral_labels = spectral.fit_predict(channels)
...
agglomerative_counts = df['Agglomerative_Cluster'].value_counts()
dbscan_counts = df['DBSCAN_Cluster'].value_counts()
spectral_counts = df['Spectral_Cluster'].value_counts()
...
plt.subplot(2, 2, 2)
plt.scatter(pca_result[:, 0], pca_result[:, 1], c=agglomerative_labels, cmap='viridis', alpha=0.5)
plt.xlabel('Principal Component 1', fontsize=10)
plt.ylabel('Principal Component 2', fontsize=10)
plt.title('Agglomerative Clustering', fontsize=12)
plt.xticks(fontsize=8)
plt.yticks(fontsize=8)
plt.grid(True, linestyle='--', alpha=0.5)
...
plt.subplot(2, 2, 4)
plt.scatter(pca_result[:, 0], pca_result[:, 1], c=spectral_labels, cmap='viridis', alpha=0.5)
plt.xlabel('Principal Component 1', fontsize=10)
plt.ylabel('Principal Component 2', fontsize=10)
