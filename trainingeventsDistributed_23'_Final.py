...
# Assume the optimal number of clusters from the Elbow method is 4
...
# Add 1 to each cluster label to make them start at 1
cluster_labels += 1
...
# Since the 'cluster' column was already present in the original data, 
# we'll simply overwrite the original CSV file with the updated data.
original_csv_path = "trainingEventsDistributed.csv"
data.to_csv(original_csv_path, index=False)
